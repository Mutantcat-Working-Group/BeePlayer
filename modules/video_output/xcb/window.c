/**
 * @file window.c
 * @brief X C Bindings window provider module for BeePlayer
 */
/*****************************************************************************
                      ...
                      uint32_t evroot)
{
    ...
    /* xgettext: This is a plain ASCII spelling of "BeePlayer"
       for the ICCCM window name. This must be pure ASCII.
       The limitation is partially with ICCCM and partially with BeePlayer.
       For Latin script languages, you may need to strip accents.
       For other scripts, you will need to transliterate into Latin. */
                   vlc_pgettext("ASCII", "BeePlayer"));
    ...
    if (title != NULL)
    {
        ...
        set_string(conn, window, utf8, net_wm_name, _("BeePlayer"));

    xcb_atom_t net_wm_icon_name = get_atom(conn, net_wm_icon_name_ck);
    set_string(conn, window, utf8, net_wm_icon_name, _("BeePlayer"));
