...
- (void)initStrings
{
    ...
    [_customizeVidResLabel setStringValue: _NS("You just need to fill one of the three following parameters, BeePlayer will autodetect the other using the original aspect ratio")];
