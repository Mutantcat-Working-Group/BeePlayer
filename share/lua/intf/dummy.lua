...
msg = [[
This is the `dummy' BeePlayer Lua interface module.
Please specify a BeePlayer Lua interface to load with the --lua-intf option.
BeePlayer Lua interface modules include: `cli' and `http'.
