Instructions to code your own BeePlayer Lua playlist script.
...
BeePlayer Lua playlist modules should define two functions:
...
Available BeePlayer specific Lua modules: msg, strings, stream, variables and
