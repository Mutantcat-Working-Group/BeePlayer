...
${LangFileString} Desc_Section04 "O plug-in ActiveX BeePlayer"
${LangFileString} Desc_Section05 "Registo da reprodução de DVD e CD"
${LangFileString} Desc_Section06 "Define o reprodutor de multimédia BeePlayer como a aplicação predefinida para o tipo de ficheiro especificado"
${LangFileString} Desc_Section07 "Adicione os itens do menu de contexto ('Reproduzir Com o BeePlayer' e 'Adicionar À Lista de Reprodução do BeePlayer')"
${LangFileString} Desc_Section08 "Apaga as preferências e os vestígios dos ficheiros da cache de instalações anteriores do reprodutor de multimédia BeePlayer"
${LangFileString} Name_Section91 "Desinstalar"
${LangFileString} Name_Section92 "Apague as preferências e a cache"
${LangFileString} Desc_Section91 "Desinstale o reprodutor de multimédia BeePlayer e todos os seus componentes"
${LangFileString} Desc_Section92 "Apaga as preferências e os ficheiros da cache do reprodutor de multimédia BeePlayer"
${LangFileString} ShellAssociation_Play "Reproduzir"
${LangFileString} ContextMenuEntry_PlayWith "Reproduzir com o reprodutor de multimédia BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Adicione à Lista de Reprodução do reprodutor de multimédia BeePlayer"
${LangFileString} Link_VisitWebsite "Visite o site da web do reprodutor de multimédia BeePlayer VideoLAN"
...
${LangFileString} MessageBox_VLCRunning "Parece que o BeePlayer está em execução e será fechado agora."
${LangFileString} MessageBox_VLCUnableToClose "O instalador não conseguiu fechar o BeePlayer, por favor, feche-o manualmente."
${LangFileString} MessageBox_InstallAborted "Instalação cancelada!"
${LangFileString} Reinstall_Headline "Já está instalado"
${LangFileString} Reinstall_HeadlineInstall "Escolha como quer instalar o BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Escolha a opção de manutenção a executar."
${LangFileString} Reinstall_MessageOlder "Uma versão anterior do BeePlayer está instalada no seu sistema. Selecione a operação que pretende realizar e clique em 'Seguinte' para continuar."
${LangFileString} Reinstall_MessageNewer "Já está instalada uma versão mais recente do BeePlayer! Não é recomendado a instalação de uma versão anterior. Selecione a operação que deseja realizar e clique em 'Seguinte' para continuar."
${LangFileString} Reinstall_MessageSame "A versão ${VERSION} do BeePlayer já está instalada. Selecione a operação que pretende realizar e clique em 'Seguinte' para continuar."
${LangFileString} Reinstall_OptionUpgrade "Atualizar o BeePlayer com as definições anteriores (recomendado)"
${LangFileString} Reinstall_OptionDowngrade "Instalar uma versão anterior do BeePlayer com as definições anteriores (recomendado)"
...
${LangFileString} Reinstall_OptionUninstall "Desinstalar o BeePlayer"
