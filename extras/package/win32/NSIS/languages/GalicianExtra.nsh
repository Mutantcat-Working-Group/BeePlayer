...
${LangFileString} Desc_Section04 "O plugin de BeePlayer para ActiveX"
${LangFileString} Desc_Section05 "O rexistro de reprodución de CD e DVD"
${LangFileString} Desc_Section06 "Define o reprodutor multimedia BeePlayer como o aplicativo predeterminado para o tipo de ficheiro especificado"
${LangFileString} Desc_Section07 "Engadir entradas de menú contextual («Reproducir co BeePlayer» e «Engadir á lista de reprodución do BeePlayer»)"
${LangFileString} Desc_Section08 "Elimina as preferencias e a caché do reprodutor multimedia BeePlayer que pertenzan a versións previas"
${LangFileString} Name_Section91 "Desinstalar"
${LangFileString} Name_Section92 "Eliminar as preferencias e a caché"
${LangFileString} Desc_Section91 "Desinstalar o reprodutor multimedia BeePlayer e todos os seus compoñentes"
${LangFileString} Desc_Section92 "Elimina as preferencias do reprodutor multimedia BeePlayer e os ficheiros da caché"
${LangFileString} ShellAssociation_Play "Reproducir"
${LangFileString} ContextMenuEntry_PlayWith "Reproducir co BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Engadir á lista de reprodución do BeePlayer"
${LangFileString} Link_VisitWebsite "Visitar a web do reprodutor multimedia VideoLAN BeePlayer"
...
${LangFileString} MessageBox_VLCRunning "Semella que o BeePlayer está a ser executado e será pechado agora."
${LangFileString} MessageBox_VLCUnableToClose "Este instalador non foi quen de pechar o BeePlayer. Fágao manualmente."
${LangFileString} MessageBox_InstallAborted "A instalación foi cancelada!"
${LangFileString} Reinstall_Headline "Xa está instalado"
${LangFileString} Reinstall_HeadlineInstall "Escolla como quere instalar o BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Seleccione a opción de mantemento que quere realizar."
${LangFileString} Reinstall_MessageOlder "No seu sistema xa está instalada unha versión máis vella do BeePlayer. Seleccione a operación que quere realizar e prema en «Seguinte» para continuar."
${LangFileString} Reinstall_MessageNewer "Xa está instalada unha versión máis nova do BeePlayer! Non se recomenda a desactualización a unha versión máis vella. Seleccione a operación que quere realizar e prema en «Seguinte» para continuar."
${LangFileString} Reinstall_MessageSame "A versión ${VERSION} do BeePlayer xa está instalada. Seleccione a operación que quere realizar e prema en «Seguinte» para continuar."
${LangFileString} Reinstall_OptionUpgrade "Actualizar o BeePlayer usando a configuración anterior (recomendado)"
${LangFileString} Reinstall_OptionDowngrade "Desactualizar o BeePlayer usando a configuración anterior (recomendado)"
