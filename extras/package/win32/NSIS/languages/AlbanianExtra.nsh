...
${LangFileString} Desc_Section04 "Plugin-i BeePlayer ActiveX"
${LangFileString} Desc_Section05 "DVD dhe CD luaj-mbrapa regjistrimin"
${LangFileString} Desc_Section06 "Vendos BeePlayer si programin  default application per kete tip file"
${LangFileString} Desc_Section07 "Shto meny kontekst mjete ('Luaj Me BeePlayer' dhe 'Shto Tek Lista BeePlayer's')"
${LangFileString} Desc_Section08 "Fshij preferencat dhe file-et e cache te BeePlayer-it te mbetura nga instalimet e meparshme"
${LangFileString} Name_Section91 "Ç'instalo "
${LangFileString} Name_Section92 "Fshi preferencat dhe depo"
${LangFileString} Desc_Section91 "Ç'instaloj aparatin BeePlayer media dhe të gjithë komponentët"
${LangFileString} Desc_Section92 "Fshij preferencat dhe file-et e cache te BeePlayer-it"
${LangFileString} ShellAssociation_Play "Luaj"
${LangFileString} ContextMenuEntry_PlayWith "Luaj me aparatin BeePlayer media "
${LangFileString} ContextMenuEntry_AddToPlaylist "Shto tek lista e apartit BeePlayer media"
${LangFileString} Link_VisitWebsite "Vizitoni faqen e aparatit VideoLAN BeePlayer media "
...
${LangFileString} MessageBox_VLCRunning "BeePlayer duket se po punon dhe tani do të mbyllet."
${LangFileString} MessageBox_VLCUnableToClose "Ky instalues nuk ishte në gjendje për të mbyllur BeePlayer, ju lutemi ta mbyllni në mënyrë manuale."
${LangFileString} MessageBox_InstallAborted "Instalimi i ndërprerë!"
${LangFileString} Reinstall_Headline "Instaluar Tashmë"
${LangFileString} Reinstall_HeadlineInstall "Zgjidhni se si ju dëshironi të instaloni BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Zgjidhni opsionin e mirëmbajtjes për të kryer."
${LangFileString} Reinstall_MessageOlder "Një version më i vjetër i BeePlayer është i instaluar në sistemin tuaj. Zgjidhni operacionin që ju dëshironi për të kryer dhe të klikoni Tjetri për të vazhduar."
${LangFileString} Reinstall_MessageNewer "Një version i ri i BeePlayer tashmë është instaluar! Nuk është e rekomanduar që ju të degradoni në një version më të vjetër. Zgjidhni operacionin që ju dëshironi për të kryer dhe të klikoni Tjetri për të vazhduar."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} është instaluar tashmë. Zgjidhni operacionin që ju dëshironi për të kryer dhe të klikoni Tjetri për të vazhduar."
${LangFileString} Reinstall_OptionUpgrade "Përmirëso BeePlayer duke përdorur cilësimet e mëparshme (e rekomanduar)"
${LangFileString} Reinstall_OptionDowngrade "Degrado BeePlayer duke përdorur cilësimet e mëparshme (e rekomanduar)"
...
${LangFileString} Reinstall_OptionUninstall "Ç'instalo BeePlayer"
