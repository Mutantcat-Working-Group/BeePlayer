...
${LangFileString} Desc_Section04 "Die BeePlayer ActiveX-inprop"
${LangFileString} Desc_Section05 "DVD en CD afspeelregistrasie"
${LangFileString} Desc_Section06 "Stel BeePlayer-mediaspeler in as die verstektoepassing vir die gespesifiseerde lêertipe"
${LangFileString} Desc_Section07 "Voeg kontekskieslysitems toe (‘Speel af met BeePlayer’ en ‘Voeg toe tot BeePlayer se afspeellys’)"
${LangFileString} Desc_Section08 "Skrap BeePlayer-mediaspelervoorkeure en kaslêers wat van vorige installasies oorgebly het"
${LangFileString} Name_Section91 "Deïnstalleer"
${LangFileString} Name_Section92 "Skrap voorkeure en kas"
${LangFileString} Desc_Section91 "Deïnstalleer BeePlayer-mediaspeler en al sy komponente"
${LangFileString} Desc_Section92 "Skrap BeePlayer-mediaspelervoorkeure en kaslêers"
${LangFileString} ShellAssociation_Play "Speel"
${LangFileString} ContextMenuEntry_PlayWith "Speel af met BeePlayer-mediaspeler"
${LangFileString} ContextMenuEntry_AddToPlaylist "Voeg toe tot BeePlayer-mediaspeler se afspeellys"
${LangFileString} Link_VisitWebsite "Besoek die VideoLAN BeePlayer-mediaspelerwebblad"
...
${LangFileString} MessageBox_VLCRunning "Dit wol voorkom of BeePlayer loop en dit sal nou afgesluit word."
${LangFileString} MessageBox_VLCUnableToClose "Die installeerder kon BeePlayer nie afsluit nie, doen dit asb. handmatig."
${LangFileString} MessageBox_InstallAborted "Installasie is laat vaar"
${LangFileString} Reinstall_Headline "Reeds geïnstalleer"
${LangFileString} Reinstall_HeadlineInstall "Kies hoe u BeePlayer wil installeer."
${LangFileString} Reinstall_HeadlineMaintenance "Kies die onderhoudopsie om uit te voer."
${LangFileString} Reinstall_MessageOlder "’n Ouer weergawe van BeePlayer is op u stelsel geïnstalleer. Kies die operasie wat u wil uitvoer en klik Volgende om aan te gaan."
${LangFileString} Reinstall_MessageNewer "’n Nuwer weergawe van BeePlayer is reeds geïnstalleer. Dit word nie aanbeveel om af te gradeer na ’n ouer weergawe nie. Kies die operasie wat u wil uitvoer en klik Volgende om aan te gaan."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} is reeds geïnstalleer. Kies die operasie wat u wil uitvoer en klik Volgende om aan te gaan."
${LangFileString} Reinstall_OptionUpgrade "Gradeer BeePlayer op deur vorige instellings te gebruik (aanbeveel)"
${LangFileString} Reinstall_OptionDowngrade "Gradeer BeePlayer af deur vorige instellings te gebruik (aanbeveel)"
...
${LangFileString} Reinstall_OptionUninstall "Deïnstalleer BeePlayer"
