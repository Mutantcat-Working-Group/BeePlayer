...
${LangFileString} Desc_Section04 "תוסף ה־ActiveX של BeePlayer"
...
${LangFileString} Desc_Section07 "הוספת פריטים לתפריט ההקשר ('נגינה עם BeePlayer' ו־'הוספה לרשימת ההשמעה של BeePlayer')"
${LangFileString} Desc_Section08 "מחיקת ההעדפות וקובצי המטמון של נגן המדיה BeePlayer שנשארו מהתקנות קודמות"
${LangFileString} Name_Section91 "הסרה"
${LangFileString} Name_Section92 "מחיקת ההעדפות והמטמון"
${LangFileString} Desc_Section91 "הסרת נגן המדיה BeePlayer על כל רכיביו"
${LangFileString} Desc_Section92 "מחיקת ההעדפות וקובצי המטמון של נגן המדיה BeePlayer"
${LangFileString} ShellAssociation_Play "נגינה"
${LangFileString} ContextMenuEntry_PlayWith "נגינה עם נגן המדיה BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "הוספה לרשימת ההשמעה של נגן המדיה BeePlayer"
${LangFileString} Link_VisitWebsite "ביקור באתר של נגן המדיה BeePlayer מבית VideoLAN"
...
${LangFileString} MessageBox_VLCRunning "נראה כי BeePlayer פעיל וכעת הוא ייסגר."
${LangFileString} MessageBox_VLCUnableToClose "תכנית התקנה זו לא הצליחה לסגור את BeePlayer, נא לעשות זאת ידנית."
${LangFileString} MessageBox_InstallAborted "ההתקנה בוטלה!"
${LangFileString} Reinstall_Headline "התכנית כבר מותקנת"
${LangFileString} Reinstall_HeadlineInstall "נא לבחור כיצד להתקין את BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "נא לבחור את אפשרות התחזוקה לביצוע."
${LangFileString} Reinstall_MessageOlder "גרסה קודמת של BeePlayer מותקנת במחשבך. נא לבחור את הפעולה הרצויה וללחוץ על הבא כדי להמשיך."
${LangFileString} Reinstall_MessageNewer "גרסה חדשה יותר של BeePlayer כבר מותקנת! לא מומלץ לעבור לגרסה ישנה יותר. נא לבחור את הפעולה הרצויה וללחוץ על הבא כדי להמשיך."
${LangFileString} Reinstall_MessageSame "גרסה ${VERSION} של BeePlayer כבר מותקנת. נא לבחור את הפעולה הרצויה וללחוץ על הבא להמשך."
${LangFileString} Reinstall_OptionUpgrade "שדרוג BeePlayer באמצעות הגדרות קודמות (מומלץ)"
${LangFileString} Reinstall_OptionDowngrade "מעבר לגרסה קודמת של BeePlayer על ידי שימוש בהגדרות קודמות (מומלץ)"
...
${LangFileString} Reinstall_OptionUninstall "הסרת BeePlayer"
