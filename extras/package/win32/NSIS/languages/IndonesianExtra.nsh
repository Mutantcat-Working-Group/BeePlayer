...
${LangFileString} Desc_Section04 "Pengaya ActiveX BeePlayer"
${LangFileString} Desc_Section05 "Registrasi pemutaran CD dan DVD"
${LangFileString} Desc_Section06 "Setel pemutar media BeePlayer sebagai aplikasi baku untuk jenis berkas tertentu"
${LangFileString} Desc_Section07 "Tambahkan butir menu konteks ('Putar dengan BeePlayer' dan 'Tambahkan Ke Daftar Putar BeePlayer')"
${LangFileString} Desc_Section08 "Hapus preferensi  pemutar media dan tembolok BeePlayer yang tertinggal dari pemasangan sebelumya"
${LangFileString} Name_Section91 "Copot"
${LangFileString} Name_Section92 "Hapus preferensi dan tembolok"
${LangFileString} Desc_Section91 "Cobot pemasangan pemutar media BeePlayer dan semua komponennya"
${LangFileString} Desc_Section92 "Hapus berkas preferensi dan tembolok pemutar media BeePlayer"
${LangFileString} ShellAssociation_Play "Putar"
${LangFileString} ContextMenuEntry_PlayWith "Putar dengan pemutar media BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Tambahkan ke daftar putar pemutar media BeePlayer"
${LangFileString} Link_VisitWebsite "Kunjungi situs web VideoLAN pemutar media BeePlayer"
...
${LangFileString} MessageBox_VLCRunning "Tampakkan BeePlayer masih berjalan dan saat ini akan ditutup."
${LangFileString} MessageBox_VLCUnableToClose "Pemasang ini tidak dapat menutup BeePlayer, silahkan lakukan secara menual."
${LangFileString} MessageBox_InstallAborted "Pemasangan dibatalkan!"
${LangFileString} Reinstall_Headline "Sudah Dipasang"
${LangFileString} Reinstall_HeadlineInstall "Pilih bagaimana anda memasang BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Pilih opsi pemeliharaan untuk dijalankan."
${LangFileString} Reinstall_MessageOlder "Versi BeePlayer yang lebih lama terpasang di sistem anda. Pilih operasi yang ingin anda laksanakan dan klik Lanjut untuk melanjutkan."
${LangFileString} Reinstall_MessageNewer "Versi BeePlayer yang terbaru sudah terpasang! Tidak direkomendasikan menurunkan ke versi yang lebih lama. Pilih operasi yang anda ingin anda lakukan dan klik Lanjut untuk melanjutkan."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} sudah terpasang. Pilih operasi yang ingin anda lakukan dan klik Lanjut untuk melanjutkan."
${LangFileString} Reinstall_OptionUpgrade "Mutakhirkan BeePlayer menggunakan pengaturan sebelumnya (direkomendasikan)"
${LangFileString} Reinstall_OptionDowngrade "Turunkan versi BeePlayer menggunakan pengaturan sebelumnya (direkomendasikan)"
...
${LangFileString} Reinstall_OptionUninstall "Copot BeePlayer"
