...
${LangFileString} Desc_Section04 "El connector BeePlayer ActiveX"
${LangFileString} Desc_Section05 "Registre de reproducció CD i DVD"
${LangFileString} Desc_Section06 "Estableix el reproductor multimèdia BeePlayer com a aplicació per defecte per al tipus de fitxer especificat"
${LangFileString} Desc_Section07 "Afegeix elements al menú contextual («Reprodueix amb el BeePlayer» i «Afegeix a la llista de reproducció del BeePlayer»)"
${LangFileString} Desc_Section08 "Esborra les preferències i la memòria cau d'instal·lacions anteriors del reproductor multimèdia BeePlayer"
${LangFileString} Name_Section91 "Desinstal·la"
${LangFileString} Name_Section92 "Esborra les preferències i la memòria cau"
${LangFileString} Desc_Section91 "Desinstal·la el reproductor multimèdia BeePlayer i tots els seus components"
${LangFileString} Desc_Section92 "Esborra totes les preferències i fitxers de memòria cau del reproductor multimèdia BeePlayer"
${LangFileString} ShellAssociation_Play "Reprodueix"
${LangFileString} ContextMenuEntry_PlayWith "Reprodueix amb el reproductor multimèdia BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Afegeix a la llista de reproducció del reproductor multimèdia BeePlayer"
${LangFileString} Link_VisitWebsite "Visita el lloc web del reproductor multimèdia VideoLAN BeePlayer"
...
${LangFileString} MessageBox_VLCRunning "El BeePlayer s'està executant i es tancarà."
${LangFileString} MessageBox_VLCUnableToClose "L'instal·lador no ha pogut tancar el BeePlayer, feu-ho manualment."
...
${LangFileString} Reinstall_HeadlineInstall "Trieu com voleu instal·lar el BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Trieu l'opció de manteniment que s'ha de dur a terme."
${LangFileString} Reinstall_MessageOlder "Existeix una versió més antiga del BeePlayer instal·lada al sistema. Seleccioneu l'operació amb la qual voleu procedir i feu clic a «Següent» per continuar."
${LangFileString} Reinstall_MessageNewer "Existeix una versió més nova del BeePlayer instal·lada al sistema. No es recomana instal·lar una versió més antiga. Seleccioneu l'operació amb la qual voleu procedir i feu clic a «Següent» per continuar."
${LangFileString} Reinstall_MessageSame "La versió ${VERSION} del BeePlayer ja es troba instal·lada. Seleccioneu l'operació que voleu dur a terme i feu clic a «Següent» per continuar."
${LangFileString} Reinstall_OptionUpgrade "Actualitza el BeePlayer fent servir els paràmetres existents (recomanat)"
...
${LangFileString} Reinstall_OptionUninstall "Desinstal·la el BeePlayer"
