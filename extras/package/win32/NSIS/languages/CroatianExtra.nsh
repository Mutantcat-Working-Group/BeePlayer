...
${LangFileString} Desc_Section04 "BeePlayer ActiveX priključak"
${LangFileString} Desc_Section05 "Registracija DVD i CD reprodukcije"
${LangFileString} Desc_Section06 "Postavlja BeePlayer medijski izvođač kao zadanu aplikaciju za određenu vrstu datoteka"
${LangFileString} Desc_Section07 "Dodaj stavke izbornika sadržaja ('Izvedi s BeePlayer' i 'Dodaj na BeePlayer popis izvođenja')"
${LangFileString} Desc_Section08 "Briše osobitosti i datoteke predmemorije zaostale od prijašnje instalacije BeePlayer medijskog izvođača"
${LangFileString} Name_Section91 "Deinstaliraj"
${LangFileString} Name_Section92 "Obriši osobitosti i predmemoriju"
${LangFileString} Desc_Section91 "Deinstaliraj BeePlayer medijski izvođač i sve njegove komponenete"
${LangFileString} Desc_Section92 "Briše osobitosti i datoteke predmemorije BeePlayer medijskog izvođača"
${LangFileString} ShellAssociation_Play "Reproduciraj"
${LangFileString} ContextMenuEntry_PlayWith "Reproduciraj s BeePlayer medijskim izvođačem"
${LangFileString} ContextMenuEntry_AddToPlaylist "Dodaj na popis izvođenja BeePlayer medijskog izvođača"
...
${LangFileString} MessageBox_VLCRunning "Čini se da je BeePlayer pokrenut i sada će bit zatvoren."
${LangFileString} MessageBox_VLCUnableToClose "Ovaj instalacijski program ne može zatvoriti BeePlayer, zatvorite ga ručno."
${LangFileString} MessageBox_InstallAborted "Instalacija prekinuta!"
${LangFileString} Reinstall_Headline "Već je instalirano"
${LangFileString} Reinstall_HeadlineInstall "Odaberite kako želite instalirati BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Odaberite mogućnost održavanja za izvođenje."
${LangFileString} Reinstall_MessageOlder "Starija inačica BeePlayer-a je instalirana na vaš sustav. Odaberite radnju koju želite izvršiti i kliknite Slijedeće za nastavak."
${LangFileString} Reinstall_MessageNewer "Novija inačica BeePlayer-a već je instalirana! Nije preporučljivo da instalirate stariju inačicu. Odaberite radnju koju želite izvršiti i kliknite Slijedeće za nastavak."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} je već instaliran. Odaberite radnju koju želite izvršiti i kliknite Slijedeće za nastavak."
${LangFileString} Reinstall_OptionUpgrade "Nadogradi BeePlayer koristeći prijašnje postavke (preporučljivo)"
${LangFileString} Reinstall_OptionDowngrade "Vrati stariju inčicu BeePlayer-a koristeći prijašnje postavke (preporučljivo)"
