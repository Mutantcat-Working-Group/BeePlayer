...
${LangFileString} Desc_Section04 "BeePlayer ActiveXプラグイン"
${LangFileString} Desc_Section05 "DVDとCD再生の登録"
${LangFileString} Desc_Section06 "指定されたファイルタイプのデフォルトアプリケーションとしてBeePlayerメディアプレイヤーを設定"
${LangFileString} Desc_Section07 "コンテキストメニューを追加 ('BeePlayerで再生'と'BeePlayerのプレイリストに追加')"
${LangFileString} Desc_Section08 "前回のインストール時から残っているBeePlayerメディアプレイヤーの設定とキャッシュを削除"
${LangFileString} Name_Section91 "アンインストール"
${LangFileString} Name_Section92 "設定とキャッシュを削除"
${LangFileString} Desc_Section91 "BeePlayerメディアプレイヤーとすべてのコンポーネントをアンインストール"
${LangFileString} Desc_Section92 "BeePlayerメディアプレイヤーの設定とキャッシュファイルを削除"
${LangFileString} ShellAssociation_Play "再生"
${LangFileString} ContextMenuEntry_PlayWith "BeePlayerメディアプレイヤーで再生"
${LangFileString} ContextMenuEntry_AddToPlaylist "BeePlayerメディアプレイヤーのプレイリストに追加"
${LangFileString} Link_VisitWebsite "VideoLAN BeePlayerメディアプレイヤーのウェブサイトを訪問"
...
${LangFileString} MessageBox_VLCRunning "BeePlayerが再生中です、閉じられます"
${LangFileString} MessageBox_VLCUnableToClose "インストーラーはBeePlayerを閉じることができません、手動で行ってください"
${LangFileString} MessageBox_InstallAborted "インストールが異常終了しました!"
${LangFileString} Reinstall_Headline "すでにインストールされています"
${LangFileString} Reinstall_HeadlineInstall "BeePlayerをどのようにインストールか選択してください"
${LangFileString} Reinstall_HeadlineMaintenance "処理したいメンテナンスオプションを選択してください"
${LangFileString} Reinstall_MessageOlder "古いバージョンのBeePlayerがシステムにインストールされています。処理したいオペレーションを選択して次へをクリックしてください。"
${LangFileString} Reinstall_MessageNewer "新しいバージョンのBeePlayerが既にインストールされています。古いバージョンへのダウングレードは推奨されていません。処理したいオペレーションを選択して次へをクリックしてください。"
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} は既にインストールされています。処理したいオペレーションを選択して次へをクリックしてください。"
${LangFileString} Reinstall_OptionUpgrade "以前の設定を使ってBeePlayerをアップグレード (推奨)"
${LangFileString} Reinstall_OptionDowngrade "以前の設定を使ってBeePlayerをダウングレード (推奨)"
${LangFileString} Reinstall_OptionComponents "コンポーネントの追加/削除/再インストール"
${LangFileString} Reinstall_OptionAdvanced "設定の変更 (詳細)"
${LangFileString} Reinstall_OptionUninstall "BeePlayerのアンインストール"
