...
${LangFileString} Desc_Section04 "Plugin-ul ActiveX BeePlayer"
${LangFileString} Desc_Section05 "Înregistrare DVD-uri și CD-uri de redare"
${LangFileString} Desc_Section06 "Setați BeePlayer ca aplicația implicită pentru tipul de fișier specificat"
${LangFileString} Desc_Section07 "Adăuga elemente de meniu ($\"Redare cu BeePlayer$\" și $\"Adăugare la Playlist-ul BeePlayer$\")"
${LangFileString} Desc_Section08 "Ștergeți BeePlayer și preferințele fisierelor cache rămase de la instalațiile anterioare"
${LangFileString} Name_Section91 "Dezinstalare"
${LangFileString} Name_Section92 "Ștergeți preferințele și cache-urile"
${LangFileString} Desc_Section91 "Dezinstalează BeePlayer și toate componentele sale"
${LangFileString} Desc_Section92 "Ștergeți preferințele BeePlayer și fișiere cache"
${LangFileString} ShellAssociation_Play "Redă"
${LangFileString} ContextMenuEntry_PlayWith "Redare cu BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Adaugați la lista de redare BeePlayer"
${LangFileString} Link_VisitWebsite "Vizitați website-ul VideoLAN BeePlayer"
...
${LangFileString} MessageBox_VLCRunning "BeePlayer pare a fi în difuzate și va fi închis."
${LangFileString} MessageBox_VLCUnableToClose "Acest program de instalare nu a putut să închidă BeePlayer-ul, vă rugăm să o faceți manual."
${LangFileString} MessageBox_InstallAborted "Instalare abandonată!"
${LangFileString} Reinstall_Headline "Deja instalat"
${LangFileString} Reinstall_HeadlineInstall "Alegeți modul în care doriți să instalați BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Alegeți efectuarea opțiunii de întreținere"
${LangFileString} Reinstall_MessageOlder "O versiune mai veche a BeePlayer este instalat pe sistem. Selectați operația pe care doriți să o efectuați și faceți clic pe Următorul pentru a continua."
${LangFileString} Reinstall_MessageNewer "O versiune mai nouă a BeePlayer este deja instalată! Nu este recomandat să reveniți la o versiune mai veche. Selectați operația pe care doriți să o efectuați și faceți clic pe Următorul pentru a continua."
${LangFileString} Reinstall_MessageSame "BeePlayer $ {VERSION} este deja instalat. Selectați operația pe care doriți să o efectuați și faceți clic pe Următorul pentru a continua."
${LangFileString} Reinstall_OptionUpgrade "Actualizare BeePlayer folosind setările anterioare (recomandat)"
${LangFileString} Reinstall_OptionDowngrade "Revenire la versiune anterioare BeePlayer folosind setările anterioare (recomandat)"
...
${LangFileString} Reinstall_OptionUninstall "Dezinstalează BeePlayer"
