...
${LangFileString} Desc_Section04 "BeePlayer-insticksmodul för ActiveX"
${LangFileString} Desc_Section05 "Uppspelningsregistrering för DVD och CD"
${LangFileString} Desc_Section06 "Ställer in BeePlayer som standardprogram för de valda filtyperna"
${LangFileString} Desc_Section07 "Lägger till objekt i högerklicksmenyn ($\"Spela upp i BeePlayer$\" och $\"Lägg till i BeePlayer-listan$\")"
${LangFileString} Desc_Section08 "Raderar inställningar och cachefiler som lämnats kvar från tidigare installationer av BeePlayer"
${LangFileString} Name_Section91 "Avinstallera"
${LangFileString} Name_Section92 "Radera inställningar och cache"
${LangFileString} Desc_Section91 "Avinstallera BeePlayer och alla dess komponenter"
${LangFileString} Desc_Section92 "Raderar BeePlayers inställningar och cachefiler"
${LangFileString} ShellAssociation_Play "Spela upp"
${LangFileString} ContextMenuEntry_PlayWith "Spela upp i BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Lägg till i BeePlayer-listan"
${LangFileString} Link_VisitWebsite "Besök VideoLANs webbsida för BeePlayer"
...
${LangFileString} MessageBox_VLCRunning "Det verkar som att BeePlayer körs och kommer nu att stängas."
${LangFileString} MessageBox_VLCUnableToClose "Denna installation kunde inte stänga BeePlayer, var god gör det manuellt."
${LangFileString} MessageBox_InstallAborted "Installationen avbröts!"
${LangFileString} Reinstall_Headline "Redan installerad"
${LangFileString} Reinstall_HeadlineInstall "Välj hur du vill installera BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Välj ett underhållsalternativ att utföra."
${LangFileString} Reinstall_MessageOlder "En äldre version av BeePlayer är installerad på ditt system. Välj åtgärden du vill utföra och klicka på Nästa för att fortsätta."
${LangFileString} Reinstall_MessageNewer "En nyare version av BeePlayer är redan installerad! Det rekommenderas inte att du nedgraderar till en äldre version. Välj åtgärden du vill utföra och klicka på Nästa för att fortsätta."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} är redan installerad. Välj den åtgärd du vill utföra och klicka på Nästa för att fortsätta."
${LangFileString} Reinstall_OptionUpgrade "Uppgradera BeePlayer med föregående inställningar (rekommenderas)"
${LangFileString} Reinstall_OptionDowngrade "Nedgradera BeePlayer med föregående inställningar (rekommenderas)"
...
${LangFileString} Reinstall_OptionUninstall "Avinstallera BeePlayer"
