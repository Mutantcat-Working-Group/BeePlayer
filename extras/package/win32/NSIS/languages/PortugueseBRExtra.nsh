...
${LangFileString} Desc_Section04 "O complemento BeePlayer ActiveX"
${LangFileString} Desc_Section05 "Registro da reprodução de DVD e CD"
${LangFileString} Desc_Section06 "Define o reprodutor de mídias BeePlayer como o aplicativo padrão para uma extensão de arquivo específica"
${LangFileString} Desc_Section07 "Adicionar itens ao menu de contexto ('Reproduzir com o BeePlayer' e 'Adicionar à Lista de Reprodução do BeePlayer')"
${LangFileString} Desc_Section08 "Exclui as preferências e arquivos de cache de instalações anteriores do reprodutor de mídias BeePlayer"
${LangFileString} Name_Section91 "Desinstalar"
${LangFileString} Name_Section92 "Excluir as preferências e o cache"
${LangFileString} Desc_Section91 "Desinstalar o reprodutor de mídias BeePlayer e todos os seus componentes"
${LangFileString} Desc_Section92 "Exclui os arquivos de preferências e de cache do reprodutor de mídias BeePlayer"
${LangFileString} ShellAssociation_Play "Reproduzir"
${LangFileString} ContextMenuEntry_PlayWith "Reproduzir com o reprodutor de mídias BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Adicionar à Lista de Reprodução do reprodutor de mídias BeePlayer"
${LangFileString} Link_VisitWebsite "Visite o sítio do reprodutor de mídias BeePlayer na Internet"
...
${LangFileString} MessageBox_VLCRunning "Parece que o BeePlayer está sendo executado e não será fechado."
${LangFileString} MessageBox_VLCUnableToClose "Este instalador não foi capaz de fechar o BeePlayer. Por favor, faça isso manualmente."
${LangFileString} MessageBox_InstallAborted "Instalação interrompida!"
${LangFileString} Reinstall_Headline "Já instalado"
${LangFileString} Reinstall_HeadlineInstall "Escolha como deseja instalar o BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Escolha a opção de manutenção que deseja executar."
${LangFileString} Reinstall_MessageOlder "Uma versão anterior do BeePlayer está instalada em seu sistema. Selecione a operação que deseja executar e clique em Próximo para continuar."
${LangFileString} Reinstall_MessageNewer "Uma versão mais recente do BeePlayer já está instalada em seu sistema e não é recomendado que você regrida para uma versão anterior. Selecione a operação que deseja e clique em Próximo para continuar."
${LangFileString} Reinstall_MessageSame "O BeePlayer ${VERSION} já está instalado. Selecione a operação que deseja executar e clique em Próximo para continuar."
${LangFileString} Reinstall_OptionUpgrade "Atualizar o BeePlayer usando configurações definidas (recomendado)"
${LangFileString} Reinstall_OptionDowngrade "Regredir a versão do BeePlayer usando as configurações definidas (recomendado)"
