...
${LangFileString} Desc_Section04 "El complemento BeePlayer de ActiveX"
${LangFileString} Desc_Section05 "Registro de reproducción DVD y CD"
${LangFileString} Desc_Section06 "Establecer el Reproductor multimedia BeePlayer como la aplicación predeterminada para el tipo de archivo especificado"
${LangFileString} Desc_Section07 "Añade opciones en el menú contextual («Reproducir con BeePlayer» y «Añadir a la lista de BeePlayer»"
${LangFileString} Desc_Section08 "Borra los archivos de caché y preferencias del reproductor multimedia BeePlayer de anteriores instalaciones"
${LangFileString} Name_Section91 "Desinstalar"
${LangFileString} Name_Section92 "Borrar caché y preferencias"
${LangFileString} Desc_Section91 "Desinstalar el reproductor multimedia BeePlayer y todos sus componentes"
${LangFileString} Desc_Section92 "Borra los archivos de caché y preferencias del reproductor multimedia BeePlayer"
${LangFileString} ShellAssociation_Play "Reproducir"
${LangFileString} ContextMenuEntry_PlayWith "Reproducir con BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Añadir a la lista de BeePlayer"
${LangFileString} Link_VisitWebsite "Visita el sitio web del reproductor multimedia VideoLAN BeePlayer"
...
${LangFileString} MessageBox_VLCRunning "Aparentemente BeePlayer se está ejecutado y será cerrado ahora."
${LangFileString} MessageBox_VLCUnableToClose "Este instalador fué incapaz de cerrar BeePlayer, por favor, hágalo usted."
${LangFileString} MessageBox_InstallAborted "Instalación cancelada"
${LangFileString} Reinstall_Headline "Ya está instalado"
${LangFileString} Reinstall_HeadlineInstall "Seleccione como quiere instalar BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Seleccione la opción de mantenimiento a realizar."
${LangFileString} Reinstall_MessageOlder "Está instalada una versión más antigua de BeePlayer en su sistema. Seleccione la operación que quiere realizar y pulse Siguiente para continuar."
${LangFileString} Reinstall_MessageNewer "Está instalada una versión más reciente de BeePlayer. No se recomienda que desactualice a una versión más antigua. Seleccione la operación que quiere realizar y pulse Siguiente para continuar."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} ya está instalado. Seleccione la operación que quiere realizar y pulse Siguiente para continuar."
${LangFileString} Reinstall_OptionUpgrade "Actualizar BeePlayer usando las preferencias siguientes (recomendado)"
${LangFileString} Reinstall_OptionDowngrade "Desactualizar BeePlayer usando las preferencias anteriores (recomendado)"
...
${LangFileString} Reinstall_OptionUninstall "Desinstalar BeePlayer"
