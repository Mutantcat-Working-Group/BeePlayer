...
${LangFileString} Desc_Section04 "BeePlayer ActiveX 外掛"
${LangFileString} Desc_Section05 "註冊 DVD 與 CD 播放"
${LangFileString} Desc_Section06 "設定 BeePlayer 媒體播放器為特定檔案類型的預設程式"
${LangFileString} Desc_Section07 "新增右鍵選單項目 (「以 BeePlayer 播放」與「新增至 BeePlayer 播放清單」)"
${LangFileString} Desc_Section08 "刪除上一個 BeePlayer 媒體播放器安裝留下來的偏好設定與快取"
${LangFileString} Name_Section91 "移除"
${LangFileString} Name_Section92 "刪除偏好設定與快取"
${LangFileString} Desc_Section91 "移除 BeePlayer 媒體播放器與所有元件"
${LangFileString} Desc_Section92 "刪除 BeePlayer 媒體播放器偏好設定與快取"
${LangFileString} ShellAssociation_Play "播放"
${LangFileString} ContextMenuEntry_PlayWith "以 BeePlayer 媒體播放器播放"
${LangFileString} ContextMenuEntry_AddToPlaylist "新增至 BeePlayer 媒體播放器的播放清單"
${LangFileString} Link_VisitWebsite "前往 the VideoLAN BeePlayer 媒體播放器網站"
...
${LangFileString} MessageBox_VLCRunning "BeePlayer 似乎正在執行中且將被關閉"
${LangFileString} MessageBox_VLCUnableToClose "安裝程式無法順利關閉 BeePlayer，請手動關閉。"
${LangFileString} MessageBox_InstallAborted "中止安裝！"
${LangFileString} Reinstall_Headline "已安裝"
${LangFileString} Reinstall_HeadlineInstall "請選擇您要如何安裝 BeePlayer。"
...
${LangFileString} Reinstall_MessageNewer "新版的 BeePlayer 已經安裝！我們不建議您降級到舊版，請選擇一個您要執行的動作並按下一步以繼續。"
${LangFileString} Reinstall_MessageSame "BeePlayer 版號 ${VERSION} 已安裝，請選擇一個您要執行的動作並按下一步以繼續。"
${LangFileString} Reinstall_OptionUpgrade "使用之前的設定值更新 BeePlayer (建議選項)"
${LangFileString} Reinstall_OptionDowngrade "使用之前的設定值降級 BeePlayer (建議選項)"
${LangFileString} Reinstall_OptionComponents "新增/移除/重新安裝 元件"
${LangFileString} Reinstall_OptionAdvanced "修改設定 (進階)"
${LangFileString} Reinstall_OptionUninstall "移除 BeePlayer"
