...
${LangFileString} Desc_Section04 "Modul BeePlayer ActiveX"
${LangFileString} Desc_Section05 "Registrace přehrávání CD a DVD"
${LangFileString} Desc_Section06 "Nastaví přehrávač BeePlayer jako výchozí aplikaci pro daný typ souborů"
${LangFileString} Desc_Section07 "Přidá položky kontextové nabídky ($\"Přehrát s BeePlayer$\" a $\"Přidat do seznamu skladeb BeePlayer$\")"
${LangFileString} Desc_Section08 "Smaže nastavení a mezipaměť přehrávače BeePlayer, které jsou pozůstatkem z předchozích instalací"
${LangFileString} Name_Section91 "Odinstalovat"
${LangFileString} Name_Section92 "Smazat nastavení a mezipaměť"
${LangFileString} Desc_Section91 "Odinstalovat přehrávač BeePlayer a všechny jeho součásti"
${LangFileString} Desc_Section92 "Smaže nastavení a mezipaměť přehrávače BeePlayer"
${LangFileString} ShellAssociation_Play "Přehrát"
${LangFileString} ContextMenuEntry_PlayWith "Přehrát s BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Přidat do seznamu skladeb BeePlayer"
${LangFileString} Link_VisitWebsite "Navštivte webové stránky přehrávače VideoLAN BeePlayer"
...
${LangFileString} MessageBox_VLCRunning "Vypadá to že přehrávač BeePlayer je spuštěn na pozadí. Bude tedy ukončen."
${LangFileString} MessageBox_VLCUnableToClose "Instalátoru se nezdařilo ukončení přehrávače BeePlayer. Prosím ukončete jej ručně."
${LangFileString} MessageBox_InstallAborted "Instalace přerušena."
${LangFileString} Reinstall_Headline "Již nainstalováno"
${LangFileString} Reinstall_HeadlineInstall "Vyberte jak si přejete BeePlayer nainstalovat."
${LangFileString} Reinstall_HeadlineMaintenance "Vyberte volbu údržby pro vykonání."
${LangFileString} Reinstall_MessageOlder "Již máte nainstalovánu starší verzi BeePlayer. Vyberte činnost k provedení a pro pokračování klikněte na Další,"
${LangFileString} Reinstall_MessageNewer "Je již nainstalována novější verze BeePlayer. Není doporučeno navracet se ke starší verzi. Vyberte činnost k provedení a pro pokračování klikněte na Další,"
${LangFileString} Reinstall_MessageSame "Přehrávač BeePlayer verze ${VERSION} je již nainstalován. Vyberte činnost k provedení a pro pokračování klikněte na Další,"
${LangFileString} Reinstall_OptionUpgrade "Aktualizovat BeePlayer pomocí předchozího nastavení (doporučeno)"
${LangFileString} Reinstall_OptionDowngrade "Snížit verzi BeePlayer s použitím předchozího nastavení (doporučeno)"
...
${LangFileString} Reinstall_OptionUninstall "Odinstalovat BeePlayer"
