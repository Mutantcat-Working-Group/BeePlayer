...
${LangFileString} Desc_Section06 "Назначить медиаплеер BeePlayer приложением по умолчанию для заданного типа файлов"
${LangFileString} Desc_Section07 "Добавить пункты контекстного меню ('Воспроизвести при помощи BeePlayer' и 'Добавить в список воспроизведения BeePlayer')"
${LangFileString} Desc_Section08 "Удаляет настройки и кэш BeePlayer от прошлых установок"
${LangFileString} Name_Section91 "Удалить"
${LangFileString} Name_Section92 "Очистить настройки и кэш"
${LangFileString} Desc_Section91 "Удалить медиаплеер BeePlayer и все его компоненты"
${LangFileString} Desc_Section92 "Удаляет медиаплеер BeePlayer и все его компоненты"
${LangFileString} ShellAssociation_Play "Воспроизвести"
${LangFileString} ContextMenuEntry_PlayWith "Воспроизвести в BeePlayer"
${LangFileString} ContextMenuEntry_AddToPlaylist "Добавить в плейлист BeePlayer"
${LangFileString} Link_VisitWebsite "Посетить сайт VideoLAN медиаплеера BeePlayer"
...
${LangFileString} MessageBox_VLCRunning "Похоже, BeePlayer сейчас запущен, его придётся закрыть."
${LangFileString} MessageBox_VLCUnableToClose "Программа установки не смогла завершить BeePlayer, пожалуйста, закройте его сами."
${LangFileString} MessageBox_InstallAborted "Установка прервана!"
${LangFileString} Reinstall_Headline "Уже установлен"
${LangFileString} Reinstall_HeadlineInstall "Выберите вариант установки BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Выберите действие, которое вы хотите выполнить."
${LangFileString} Reinstall_MessageOlder "В вашей системе установлена более старая версия BeePlayer. Выберите действие, которое вы хотите совершить, и нажмите Далее."
${LangFileString} Reinstall_MessageNewer "В вашей системе уже установлена более новая версия BeePlayer! Возвращаться к старой версии не рекомендуется. Выберите действие, которое вы хотите совершить, и нажмите Далее для продолжения."
${LangFileString} Reinstall_MessageSame "Установлена версия BeePlayer ${VERSION}. Выберите действие, которое вы хотите совершить, и нажмите Далее для продолжения."
${LangFileString} Reinstall_OptionUpgrade "Обновить BeePlayer, используя предыдущие настройки (рекомендуется)"
${LangFileString} Reinstall_OptionDowngrade "Понизить версию BeePlayer, используя предыдущие настройки (рекомендуется)"
...
${LangFileString} Reinstall_OptionUninstall "Удалить BeePlayer"
