...
${LangFileString} Desc_Section06 "Поставља BeePlayer као подразумевани програм за наведени тип датотека"
${LangFileString} Desc_Section07 "Додаје ставке у контекстуални мени („Репродукуј помоћу BeePlayer-а“ и „Додај у плејлисту BeePlayer-а“)"
${LangFileString} Desc_Section08 "Брише датотеке са поставкама и кешом BeePlayer-а које су остале од претходних инсталација"
${LangFileString} Name_Section91 "Деинсталирај"
${LangFileString} Name_Section92 "Обриши поставке и кеш"
${LangFileString} Desc_Section91 "Деинсталирај BeePlayer и све његове компоненте"
${LangFileString} Desc_Section92 "Брише датотеке са поставкама и кешом BeePlayer-а"
${LangFileString} ShellAssociation_Play "Репродукуј"
${LangFileString} ContextMenuEntry_PlayWith "Репродукуј помоћу BeePlayer-а"
${LangFileString} ContextMenuEntry_AddToPlaylist "Додај у плејлисту BeePlayer-а"
${LangFileString} Link_VisitWebsite "Посети сајт BeePlayer-а"
...
${LangFileString} MessageBox_VLCRunning "Изгледа да је BeePlayer покренут. Сада ће бити затворен."
${LangFileString} MessageBox_VLCUnableToClose "Инсталациони програм не може да затвори BeePlayer. Учините то ручно."
${LangFileString} MessageBox_InstallAborted "Инсталација је прекинута!"
${LangFileString} Reinstall_Headline "Већ је инсталиран"
${LangFileString} Reinstall_HeadlineInstall "Изаберите како желите да инсталирате BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Изаберите опцију одржавања коју желите да извршите."
${LangFileString} Reinstall_MessageOlder "На вашем систему је инсталирана старија верзија BeePlayer-а. Изаберите жељену радњу и кликните на „Следеће“ да бисте наставили."
${LangFileString} Reinstall_MessageNewer "Инсталирана је новија верзија BeePlayer-а. Не препоручујемо вам да се враћате на старију верзију. Изаберите жељену радњу и кликните на „Следеће“ да бисте наставили."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} је већ инсталиран. Изаберите жељену радњу и кликните на „Следеће“ да бисте наставили."
${LangFileString} Reinstall_OptionUpgrade "Надогради BeePlayer помоћу претходних поставки (препоручује се)"
${LangFileString} Reinstall_OptionDowngrade "Уназади BeePlayer помоћу претходних поставки (препоручује се)"
...
${LangFileString} Reinstall_OptionUninstall "Деинсталирај BeePlayer"
