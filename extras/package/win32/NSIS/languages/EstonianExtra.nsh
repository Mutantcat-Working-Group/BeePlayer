...
${LangFileString} Desc_Section04 "BeePlayer ActiveX plugin"
${LangFileString} Desc_Section05 "DVD ja CD taasesitus registratsioon"
${LangFileString} Desc_Section06 "Määrab BeePlayer meediaesitaja vaikimisi rakenduseks sellele faili tüübile"
${LangFileString} Desc_Section07 "Lisa konteksti menüüle ('Mängi BeePlayer'ga' ja 'Lisa BeePlayer esitusloendisse')"
${LangFileString} Desc_Section08 "Kustutab BeePlayer meediaesitaja eelistused ja vahemälu failide ülejäägid eelmistest installerimistest"
${LangFileString} Name_Section91 "Eemalda"
${LangFileString} Name_Section92 "Kustuta eelistused ja vahemälu"
${LangFileString} Desc_Section91 "Eemalda BeePlayer meediaesitaja ja kõik selle lisad"
${LangFileString} Desc_Section92 "Kustutab BeePlayer meediaesitaja eelistused ja vahemälu failid"
${LangFileString} ShellAssociation_Play "Esita"
${LangFileString} ContextMenuEntry_PlayWith "Esita BeePlayer meediaesitajaga"
${LangFileString} ContextMenuEntry_AddToPlaylist "Lisa BeePlayer meediaesitaja esitusloendisse"
${LangFileString} Link_VisitWebsite "Külasta VideoLAN BeePlayer meediaesitaja veebilehte"
...
${LangFileString} MessageBox_VLCRunning "BeePlayer tundub töötavat ning see suletakse nüüd."
${LangFileString} MessageBox_VLCUnableToClose "See installeerija ei suutnud sulgeda BeePlayer'd, palun tehke seda manuaalselt."
...
${LangFileString} Reinstall_HeadlineInstall "Vali kuidas sa tahad installeerida BeePlayer'd."
${LangFileString} Reinstall_HeadlineMaintenance "Valige hoolduse seade, et sooritada."
${LangFileString} Reinstall_MessageOlder "Vanem versioon BeePlayer'st on juba installeeritud su süsteemis. Vali tehe mida soovite sooritada ning vajutage Edasi, et jätkata."
${LangFileString} Reinstall_MessageNewer "Uuem versioon BeePlayer'st on juba installeeritud! Ei ole soovitatud minna tagasi vanemale versioonile. Vali tehe mida soovite sooritada ning vajutage Edasi, et jätkata."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} on juba installeeritud. Vali tehe mida soovite sooritada ning vajutage Edasi, et jätkata."
${LangFileString} Reinstall_OptionUpgrade "Uuenda BeePlayer'd kasutades eelmisi seadeid (soovitatud)"
${LangFileString} Reinstall_OptionDowngrade "Madalda BeePlayer'd kasutades eelmisi seadeid (soovitatud)"
...
${LangFileString} Reinstall_OptionUninstall "Eemalda BeePlayer"
