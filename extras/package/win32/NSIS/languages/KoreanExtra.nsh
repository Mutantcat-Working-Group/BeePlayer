...
${LangFileString} Desc_Section04 "BeePlayer 액티브엑스 플러그인"
${LangFileString} Desc_Section05 "DVD / CD 재생 등록"
${LangFileString} Desc_Section06 "지정한 파일 형식에 대해 BeePlayer 미디어 재생기를 기본 프로그램으로 설정합니다"
${LangFileString} Desc_Section07 "컨텍스트 메뉴 항목 추가하기 ('BeePlayer로 재생하기', 'BeePlayer 재생목록에 추가하기')"
${LangFileString} Desc_Section08 "이전에 설치된 BeePlayer 미디어 플레이어의 환경설정과 남은 캐쉬 파일을 완전히 삭제합니다"
${LangFileString} Name_Section91 "제거하기"
${LangFileString} Name_Section92 "환경설정과 캐쉬 제거하기"
${LangFileString} Desc_Section91 "BeePlayer 미디어 플레이어와 종속된 모든 컴포넌트를 제거합니다"
${LangFileString} Desc_Section92 "BeePlayer 미디어 플레이어 환경설정과 캐쉬 파일을 삭제합니다"
${LangFileString} ShellAssociation_Play "재생"
${LangFileString} ContextMenuEntry_PlayWith "BeePlayer 로 재생하기"
${LangFileString} ContextMenuEntry_AddToPlaylist "BeePlayer의 재생목록에 추가하기"
${LangFileString} Link_VisitWebsite "VideoLAN BeePlayer 웹사이트에 방문하기"
...
${LangFileString} MessageBox_VLCRunning "BeePlayer가 실행중인데, 곧 종료될 것입니다. "
${LangFileString} MessageBox_VLCUnableToClose "BeePlayer를 종료할 수 없습니다. 직접 종료해 주세요."
${LangFileString} MessageBox_InstallAborted "설치를 중단했습니다!"
${LangFileString} Reinstall_Headline "이미 설치했습니다"
${LangFileString} Reinstall_HeadlineInstall "BeePlayer 설치 방법을 선택하세요."
${LangFileString} Reinstall_HeadlineMaintenance "수행할 관리 옵션을 선택하세요."
${LangFileString} Reinstall_MessageOlder "이전 버전의 BeePlayer가 이미 설치되어 있습니다. 수행할 동작을 선택하고 다음을 눌러 계속하세요."
${LangFileString} Reinstall_MessageNewer "새 버전의 BeePlayer가 이미 설치되어 있습니다! 이전 버전으로 다운그레이드는 권장하지 않습니다. 수행할 동작을 선택하고 다음을 눌러 계속하세요."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} 가 이미 설치되어 있습니다. 수행할 동작을 선택하고 다음을 눌러 계속하세요."
${LangFileString} Reinstall_OptionUpgrade "이전 설정값을 사용하여 BeePlayer 업그레이드 (권장)"
...
${LangFileString} Reinstall_OptionUninstall "BeePlayer 제거하기"
