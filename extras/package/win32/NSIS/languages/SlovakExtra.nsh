...
${LangFileString} Desc_Section06 "Nastaví prehrávač BeePlayer ako predvolenú aplikáciu pre špecifikovaný typ súboru"
${LangFileString} Desc_Section07 "Pridá položky kontextového menu ('Prehrať v programe BeePlayer' a 'Pridať do playlistu programu BeePlayer')"
${LangFileString} Desc_Section08 "Vymaže nastavenia prehrávača BeePlayer a vyrovnávaciu pamäť z predchádzajúcich inštalácií"
${LangFileString} Name_Section91 "Odinštalovať"
${LangFileString} Name_Section92 "Vymazať nastavenia a vyrovnávaciu pamäť"
${LangFileString} Desc_Section91 "Odinštalovať program BeePlayer a všetky jeho súčasti"
${LangFileString} Desc_Section92 "Vymaže nastavenia programu BeePlayer a súbory vo vyrovnávacej pamäti"
${LangFileString} ShellAssociation_Play "Prehrať"
${LangFileString} ContextMenuEntry_PlayWith "Prehrať v programe BeePlayer Media Player"
${LangFileString} ContextMenuEntry_AddToPlaylist "Pridať do playlistu BeePlayer"
${LangFileString} Link_VisitWebsite "Navštíviť webovú stránku programu VideoLAN BeePlayer"
...
${LangFileString} MessageBox_VLCRunning "Zdá sa, že program BeePlayer je práve spustený a preto bude ukončený."
${LangFileString} MessageBox_VLCUnableToClose "Tento inštalátor nemohol ukončiť program BeePlayer, prosím urobte to manuálne."
${LangFileString} MessageBox_InstallAborted "Inštalácia bola prerušená!"
${LangFileString} Reinstall_Headline "Už nainštalované"
${LangFileString} Reinstall_HeadlineInstall "Vyberte si, ako chcete nainštalovať BeePlayer."
${LangFileString} Reinstall_HeadlineMaintenance "Vyberte si možnosť pre údržbu."
${LangFileString} Reinstall_MessageOlder "Vo vašom počítači je nainštalovaná staršia verzia programu BeePlayer. Vyberte si úkon, ktorý chcete vykonať a pokračujte kliknutím na tlačidlo Ďalej."
${LangFileString} Reinstall_MessageNewer "Už je nainštalovaná novšia verzia programu BeePlayer! Neodporúča sa návrat k staršej verzii programu. Vyberte si úkon, ktorý chcete vykonať a pokračujte kliknutím na tlačidlo Ďalej."
${LangFileString} Reinstall_MessageSame "Už je nainštalovaný program BeePlayer ${VERSION}. Vyberte si úkon, ktorý chcete urobiť a pokračujte kliknutím na tlačidlo Ďalej."
${LangFileString} Reinstall_OptionUpgrade "Aktualizovať BeePlayer s použitím predchádzajúcich nastavení (odporúča sa)"
${LangFileString} Reinstall_OptionDowngrade "Prejsť na staršiu verziu BeePlayer, s použitím predchádzajúcich nastavení (odporúča sa)"
...
${LangFileString} Reinstall_OptionUninstall "Odinštalovať BeePlayer"
