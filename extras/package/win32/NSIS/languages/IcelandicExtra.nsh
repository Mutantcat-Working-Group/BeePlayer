...
${LangFileString} Desc_Section04 "BeePlayer ActiveX íforrit"
${LangFileString} Desc_Section05 "Skráning á  afspilun DVD og CD"
${LangFileString} Desc_Section06 "Stillir BeePlayer-margmiðlunarspilarann sem sjálfgefið forrit fyrir tilgreindar skráategundir"
${LangFileString} Desc_Section07 "Bæta við línum í samhengisvalmynd ('Spila með BeePlayer' og 'Setja á spilunarlista BeePlayer')"
${LangFileString} Desc_Section08 "Eyðir kjörstillingum BeePlayer og skrám í skyndiminni sem gætu verið afgangs eftir fyrri uppsetningar"
${LangFileString} Name_Section91 "Henda út"
${LangFileString} Name_Section92 "Eyða kjörstillingum og skyndiminni"
${LangFileString} Desc_Section91 "Henda út BeePlayer-margmiðlunarspilaranum og öllum tengdum einingum"
${LangFileString} Desc_Section92 "Eyðir kjörstillingum BeePlayer og skrám í skyndiminni"
${LangFileString} ShellAssociation_Play "Spila"
${LangFileString} ContextMenuEntry_PlayWith "Spila með BeePlayer spilaranum"
${LangFileString} ContextMenuEntry_AddToPlaylist "Bæta á spilunarlista BeePlayer"
${LangFileString} Link_VisitWebsite "Heimsækja vef VideoLAN BeePlayer margmiðlunarspilarans"
...
${LangFileString} MessageBox_VLCRunning "BeePlayer virðist vera í gangi og verður núna lokað."
${LangFileString} MessageBox_VLCUnableToClose "Uppsetningarforritið gat ekki lokað BeePlayer, þú verður að gera það handvirkt."
${LangFileString} MessageBox_InstallAborted "Hætt við uppsetningu!"
${LangFileString} Reinstall_Headline "Þegar uppsett"
${LangFileString} Reinstall_HeadlineInstall "Veldu hvernig þú vilt setja upp BeePlayer ."
${LangFileString} Reinstall_HeadlineMaintenance "Veldu þá viðhaldsaðgerð sem þú vilt framkvæma."
${LangFileString} Reinstall_MessageOlder "Eldri útgáfa BeePlayer er uppsett á kerfinu þínu. Veldu þá aðgerð sem þú vilt framkvæma og smelltu á Næsta til að halda áfram."
${LangFileString} Reinstall_MessageNewer "Nýrri útgáfa BeePlayer er þegar uppsett! Ekki er mælt með því að niðurfæra í eldri útgáfu. Veldu þá aðgerð sem þú vilt framkvæma og smelltu á Næsta til að halda áfram."
${LangFileString} Reinstall_MessageSame "BeePlayer ${VERSION} er þegar uppsett. Veldu þá aðgerð sem þú vilt framkvæma og smelltu á Næsta til að halda áfram."
${LangFileString} Reinstall_OptionUpgrade "Uppfæra BeePlayer með fyrri stillingum (mælt með þessu)"
${LangFileString} Reinstall_OptionDowngrade "Niðurfæra BeePlayer með fyrri stillingum (mælt með þessu)"
...
${LangFileString} Reinstall_OptionUninstall "Henda BeePlayer út"
